 ...
 * Formal testing frameworks provide this functionality, but this makes the
 * process transparent to students.
...
public class Assert {
	 ...
	 */
	public static void assertEquals(Double expect, Double result, Double threshold, String msg) {
		boolean match = true;
